...
<option value="West Bengal">West Bengal</option>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    <button type="button" class="btn" onclick="location.href='';">Order Ticket Now</button>
                                </fieldset>
                            </div>
                        </div>
                    </form>
...
$sql = "INSERT INTO bookings (from_location, to_location, departuredate, returndate, trip)
VALUES ('$from', '$to', '$departuredate', '$returndate', '$trip')";
